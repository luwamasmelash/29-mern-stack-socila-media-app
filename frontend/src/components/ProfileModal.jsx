            ...
            <div className='max-w-2xl sm:py-6 mx-auto'>
                <div className='bg-white rounded-lg shadow p-6'>
                    ...
                    <form className='space-y-4' onSubmit={handleSaveProfile}>
                        ...
                        <div>
                            {/* 
                              FIX: We wrap the text, input, and image container altogether.
                              Clicking the image or the overlay now triggers the file dialog window.
                            */}
                        ...
                        <div className='flex flex-col items-start gap-3'>
                            <label htmlFor="cover_photo" className="block text-sm font-medium text-gray-700 mb-1 cursor-pointer">
                                ...
                                {/* 
          FIXED: Combined 'group/cover relative' layout container inside the label 
          so clicking the image preview or hover overlay triggers the file browser.
        */}
                                <div className='group/cover relative mt-2'>
                                    <img
                                        ...
                                        alt=""
                                        className='w-80 h-44 rounded-lg bg-gradient-to-r from-indigo-200 via-purple-200 to-pink-200 object-cover'
                                    />
                        ...
                        <div>
                            ...
                            <textarea
                                rows={3}
                                className='w-full p-3 border border-gray-200 rounded-lg'
                                placeholder='Please enter your bio' // Fixed placeholder logic error
